...
from ss_beijing.crawl_main import SpiderMain
from ss_beijing.constants_spider import THREAD_NUM, THREAD_Q_SIZE, SOURCE

reload(sys)
sys.setdefaultencoding("utf8")
logging.config.fileConfig('ss_beijing/logging.config')
...
def run():
    ...
    # dict_json = {
    #     'idcard': '412726199612102456',
    #     'password' : '123',
    #     'token' : 'adfadsfadqafqergfqa',
    # }

    # client.taskWork(dict_json)
