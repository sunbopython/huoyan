...
from qiyegsxtConstants import THREAD_NUM, THREAD_Q_SIZE, SOURCE
import time
...
class SpiderClient():
        ...
        while True:
            try:
                ...
                if dict_json is not None:
                    ...
                    # sendMail(u"邮件log测试",'sunbo@insightcredit.cn')
    ...
    def taskWork(self, dict_json):
        ...
        try:
            ...
            p1 = threading.Thread(target=client.crawl, args=("user",),name="crawl")
