...
from telecom.crawl_main import SpiderMain
from telecom.constants_spider import THREAD_NUM, THREAD_Q_SIZE, SOURCE

reload(sys)
sys.setdefaultencoding("utf8")
logging.config.fileConfig('%s/logging.config'%SOURCE)
